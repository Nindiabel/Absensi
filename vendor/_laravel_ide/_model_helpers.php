...
namespace App\Models {
     ...
     * App\Models\User
     *
     * @property int(11)|null $deleted_by
     * @property \Illuminate\Support\Carbon|null $deleted_at
     * @property int(11)|null $updated_by
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property int(11) $created_by
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property tinyint(4)|null $is_active
     * @property string|null $remember_token
     * @property hashed $password
     * @property \Illuminate\Support\Carbon|null $email_verified_at
     * @property string|null $email
     * @property string $name
     * @property int(11)|null $access_type
     * @property int(11)|null $tenant_id
     * @property int $id
