            ...
            <div class="card-body p-4 text-center">
                ...
                @if (in_array($data->status_kehadiran ?? '', ['alpha', 'izin', 'sakit']))
                    <div class="d-flex flex-column align-items-center justify-content-center"
                        style="height:250px; background:#f8f9fa; border-radius:8px;">
                ...
                @elseif (!empty($data->foto_absensi))
                    <img src="{{ asset('storage/' . $data->foto_absensi) }}" class="img-fluid rounded shadow-sm"
            ...
            <div class="card-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <p class="mb-0 fs-5">
                            <strong class="text-dark">{{ $data->member_name ?? '-' }}</strong>
                        </p>
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <p class="mb-0 fs-5">
                            <strong class="text-dark">{{ $data->category_name ?? '-' }}</strong>
                        </p>
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        ...
                        <p class="mb-0 fs-5">
                            <strong class="text-dark">
                                {{ !empty($data->tanggal_absensi) ? date('d/m/Y', strtotime($data->tanggal_absensi)) : '-' }}
                            </strong>
                        </p>
                    </div>
                    ...
                    <div class="col-md-4 mb-2">
                        <label class="text-muted">Jam Pulang</label>
                        <p class="mb-0 fs-5">
                            <strong class="text-dark">
