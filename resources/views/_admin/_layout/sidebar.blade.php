...
<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            <a class="sidebar-link {{ $page == 'app' ? 'active' : '' }}" href="{{ base_url('app') }}"
        ...
        <li class="sidebar-item">
            <a class="sidebar-link {{ $page == 'smart-keuangan' ? 'active' : '' }}"
                href="{{ base_url('smart-keuangan') }}" aria-expanded="false" navigate>
                @include('_admin._layout.icons.dashboard')
                <span class="hide-menu">SmartKeuangan</span>
            </a>
        </li>
        <li class="sidebar-item">
            <a class="sidebar-link {{ $page == 'classe' ? 'active' : '' }}" href="{{ base_url('classe') }}"
                aria-expanded="false" navigate>
                @include('_admin._layout.icons.dashboard')
        ...
        <li class="sidebar-item">
            <a class="sidebar-link {{ $page == 'setting' ? 'active' : '' }}" href="{{ base_url('setting/general') }}"
                aria-expanded="false" navigate>
