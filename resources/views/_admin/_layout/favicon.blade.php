<link rel="apple-touch-icon" sizes="57x57" href="{{ url('admin-ui') }}/assets/images/logos/favicon/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="{{ url('admin-ui') }}/assets/images/logos/favicon/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="{{ url('admin-ui') }}/assets/images/logos/favicon/apple-icon-72x72.png">
